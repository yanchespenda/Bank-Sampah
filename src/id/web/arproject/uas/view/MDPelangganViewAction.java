 ...
 * @author Mea
 */
public class MDPelangganViewAction extends javax.swing.JDialog {
    ...
    /**
     * Creates new form MDPelangganViewAction
     */
    public MDPelangganViewAction(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(btnAksiSimpan, javax.swing.GroupLayout.PREFERRED_SIZE, 125, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 95, Short.MAX_VALUE)
                .addComponent(btnAksiBatal, javax.swing.GroupLayout.PREFERRED_SIZE, 133, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
    ...
    private void btnAksiBatalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAksiBatalActionPerformed
        ...
        System.out.println("Aksi: MDPelangganViewAction | Batal");
        this.dispose();
    ...
    private void btnAksiSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAksiSimpanActionPerformed
        ...
        if (dataType == 1) {
            pelangganController.simpan(this, inputNama, inputNoTelepon, inputAlamat);
        } else if (dataType == 2) {
            pelangganController.update(this, inputNama, inputNoTelepon, inputAlamat);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MDPelangganViewAction.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MDPelangganViewAction dialog = new MDPelangganViewAction(new javax.swing.JFrame(), true);
